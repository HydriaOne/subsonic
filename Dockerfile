#Subsonic StandAlone Docker Image v6.1.5
FROM ubuntu:16.04
MAINTAINER Hydria
...
RUN wget -qO- https://s3-eu-west-1.amazonaws.com/subsonic-public/download/subsonic-6.1.5-standalone.tar.gz | tar xvz -C /opt/subsonic
